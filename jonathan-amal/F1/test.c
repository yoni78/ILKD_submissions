...
{
	test_rotation(right,
		      "002002112115115115223225225000333333144044044334554554");
}

TEST(write_test_rotate_up)
{
	test_rotation(up,
		      "100100222223115115000225225144333333115044044334554554");
}

TEST(write_test_rotate_left)
{
	test_rotation(left,
		      "400400522112112553100125225144333333115045043034254254");
}

TEST(write_test_rotate_back)
{
	test_rotation(back,
		      "433400522012012453100125225144335332001441355034254115");
}

TEST(write_test_rotate_down)
{
	test_rotation(down,
		      "433400522012012355100125453144335225001441332120153544");
}
